...
Выступи в роли эмпатичного арт-терапевта. Напиши короткий, красивый и утешающий комментарий (3-4 предложения), объясняющий, почему эта работа отражает текущее состояние пользователя. Опирайся на музейные факты, визуальный образ, описание, темы, материалы и происхождение работы. Обращайся к пользователю на "ты". Не используй списки в ответе.`
